...
namespace Microsoft.Data.OData
{
    ...
    internal static class ODataSwaggerUtilities
    {
        ...
        public static JObject CreateSwaggerPathForEntitySet(IEdmEntitySet entitySet)
        {
        ...
        public static JObject CreateSwaggerPathForEntity(IEdmEntitySet entitySet)
        {
            //IEdmEntitySet entitySet = navigationSource as IEdmEntitySet;
            //if (entitySet == null)
            //{
        ...
        public static JObject CreateSwaggerPathForOperationImport(IEdmFunctionImport operationImport)
        {
        ...
        public static JObject CreateSwaggerPathForOperationOfEntitySet(IEdmFunctionImport operation, IEdmEntitySet entitySet)
        {
        ...
        public static JObject CreateSwaggerPathForOperationOfEntity(IEdmFunctionImport operation, IEdmEntitySet entitySet)
        {
            if (operation == null || entitySet == null)
            {
                return new JObject();
        ...
        public static string GetPathForOperationImport(IEdmFunctionImport operationImport)
        {
            if (operationImport == null)
            {
                return String.Empty;
        ...
        public static string GetPathForOperationOfEntitySet(IEdmFunctionImport operation, IEdmEntitySet entitySet)
        {
            if (operation == null || entitySet == null)
            {
                return String.Empty;
            ...
            string swaggerOperationPath = "/" + entitySet.Name + "/" + operation.Name + "(";
        ...
        /// <param name="navigationSource">The Edm navigation source.</param>
        /// <returns>The <see cref="System.String"/> path represents the related Edm operation.</returns>
        public static string GetPathForOperationOfEntity(IEdmFunctionImport operation, IEdmEntitySet entitySet)
        {
            if (operation == null || entitySet == null)
            {
                return String.Empty;
            ...
            string swaggerOperationPath = GetPathForEntity(entitySet) + "/" + operation.Name + "(";
            //if (operation.IsFunction())
            //{
                foreach (var parameter in operation.Parameters.Skip(1))
                {
        ...
        public static string FullTypeName(this IEdmType type)
        {
            ...
            else
            {
                ...
                return namedDefinition != null ? string.Format(CultureInfo.InvariantCulture,
                    "Collection({0})",
                    namedDefinition.FullName()) : null;
            }
        }
    }
}
